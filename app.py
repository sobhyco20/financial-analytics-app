...
tab_tb, tab_data, tab_overview, tab_ts, tab_dim_prod, tab_dim_cust, tab_cash, tab_fcst, tab_vat, tab_cmp, tab_export = st.tabs([
    "📚 ميزان المراجعة", "📂 ملف البيانات", "📌 نظرة عامة", "⏱️ تحليل زمني",
